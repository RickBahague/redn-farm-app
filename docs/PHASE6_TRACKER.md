...
**Naming note:** In **`USER_STORIES.md`**, **EXP-US-02** is **Clear / truncate tables** (**shipped 2026-04-09**; see status note in `USER_STORIES.md`). This tracker’s **P6-3** is **selective multi-table export**, not truncate.
